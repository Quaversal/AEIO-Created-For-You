      ...
      <div className="mx-auto max-w-6xl px-6">
        <Reveal>
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-foreground/70">With our team ranging from PhD professors to accredited elementary school teachers, you'll find just what you're looking for below.
