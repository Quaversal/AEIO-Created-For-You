        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-foreground/70">
              ...
              <li><a href="https://support.aeiocreatedforyou.org" target="_blank" rel="noopener noreferrer" className="transition hover:text-primary">Support</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-foreground/70">
              <li className="flex items-center gap-2"><a href="mailto:founderlaura@aeiocreatedforyou.org" className="flex items-center gap-2 transition hover:text-primary"><Mail className="h-4 w-4 text-primary" /> founderlaura@aeiocreatedforyou.org</a></li>
